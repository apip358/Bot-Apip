...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'FN:√Apip√\n' // Nama Lu
            + 'ORG:#Apip;\n' // Nama Kontak Owner
            + 'TEL;type=CELL;type=VOICE;waid=6285875158363:+62 895-2742-2994\n' // Nomer Lu cok
            + 'END:VCARD'
prefix = "#"
blocked = []
...
async function starts() {
	...
	anker.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '❰ ⏳ ❱ *Sabar Tod! Sedang di Prosess* ❰ ⏳ ❱',
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '6289527422994@s.whatsapp.net'
